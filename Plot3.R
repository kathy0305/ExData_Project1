...
##Plot using three categories Sub_metering_1,Sub_metering_2,Sub_metering_3
## y-axix Energy Sub Metering
## x-axis No label, no main title
## Need a legend in the top right
## using three colors, Black, Red and Blue

## plot the first category
with(DN, plot(DateTime, Sub_metering_1, type="l", 
              xlab="", ylab="Energy sub metering"))
## to add the other two, add lines or plot again on top of original plot
## simply add a line
